const PrivacyPolicy = () => {
  return (
    <div className="w-1/2 mx-auto my-8 max-sm:container max-sm:px-4">
      <h1 className="text-2xl font-bold">プライバシーポリシー</h1>
      <div className="text-sm my-8 leading-6">
        NPO法人日本ダボス会議（以下，「当団体」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        <dl>
          <div className="my-2">
            <dt className="my-2 font-bold">第1条（個人情報）</dt>
            <dd className="text-sm leading-6">
              「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
            </dd>
          </div>
          <dt className="my-2 font-bold">第2条（個人情報の収集方法）</dt>
          <dd className="text-sm leading-6">
            当たる団体は，ユーザーが利用登録をする際に氏名，生年月日，住所，電話番号，メールアドレス，銀行口座番号，クレジットカード番号，運転免許証番号などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当たる団体の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
          </dd>
          <dt className="my-2 font-bold">
            第3条（個人情報を収集・利用する目的）
          </dt>
          <dd className="text-sm leading-6">
          ...
          <dt className="my-2 font-bold">第4条（利用目的の変更）</dt>
          <dd className="text-sm leading-6">
          ...
          <dt className="my-2 font-bold">第5条（個人情報の第三者提供）</dt>
          <dd className="text-sm leading-6">
          ...
          <dt className="my-2 font-bold">第6条（個人情報の開示）</dt>
          <dd className="text-sm leading-6">
          ...
          <dt className="my-2 font-bold">第7条（個人情報の訂正および削除）</dt>
          <dd className="text-sm leading-6">
          ...
          <dt className="my-2 font-bold">第8条（個人情報の利用停止等）</dt>
          <dd className="text-sm leading-6">
          ...
          <dt className="my-2 font-bold">第10条（お問い合わせ窓口）</dt>
